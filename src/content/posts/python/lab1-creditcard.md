...
---
## <u>introduction</u>
The goal of this assignment is to give you more practice with functions, including testing functions and modeling function call
behavior with stack frames. For this assignment, you will implement functions that take a variety of parameter types and return a
variety of types.
...
creating the project in the right place, or you will likely have trouble finding your files later. Then download the starter code
...
whether a number is potentially a valid credit card number. You can read more about credit card numbers in this article.
...
After you think your function is working correctly, you should test your function with different input arguments and compare the
return value with the expected result.
You may find it helpful to use a website to verify whether numbers actually satisfy the Luhn algorithm.
